...
def make_model(qtrs_train, batch_size, lookforward, steps, epoch_steps, val_steps, testing_steps, partition, num_layers, neurons, dropout, optimizer, epochs):
    ...
    s3.Bucket('loan-performance-data').upload_file(model_name, 'saved_models/rolling_models3/'+model_name)
...
for learning_rate in learning_rates:
  make_model(qtrs_train, batch_size, 12, 1, 5000, 500, 2500, 5, layer_count, neurons, dropout, optimizers.RMSprop(learning_rate = learning_rate), 10)
