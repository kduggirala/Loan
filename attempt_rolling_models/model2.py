...
model = Sequential()
model.add(layers.LSTM(32, dropout = dropout, recurrent_dropout = dropout, input_shape = ((lookforward//steps), 21), return_sequences = True))
...
model.save('model2000v2.h5')
s3.Bucket('loan-performance-data').upload_file('model2000v2.h5', 'saved_models/rolling_models/model2000v2.h5')
