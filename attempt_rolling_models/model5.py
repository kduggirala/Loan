...
model = Sequential()
model.add(layers.LSTM(32, dropout = dropout, recurrent_dropout = recurrent_dropout, input_shape = ((lookforward//steps), 21), return_sequences = True))
model.add(layers.LSTM(32, dropout = dropout, recurrent_dropout = recurrent_dropout, return_sequences = True))
...
#this moves the window on the kfold partition between opochs
...
model.save('model2000v5.h5')
s3.Bucket('loan-performance-data').upload_file('model2000v5.h5', 'saved_models/rolling_models/model2000v5.h5')
