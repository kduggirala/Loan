...
model = Sequential()
model.add(layers.LSTM(32, dropout = dropout, recurrent_dropout = dropout, input_shape = ((lookforward//steps), 7), return_sequences = True))
...
s3.Bucket('loan-performance-data').upload_file('model9.h5', 'saved_models/model9.h5')
