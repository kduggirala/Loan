...
model = Sequential()
model.add(layers.LSTM(32, dropout = dropout, recurrent_dropout = recurrent_dropout, input_shape = ((lookforward//steps - 1), 7)))
...
s3.Bucket('loan-performance-data').upload_file('model6.h5', 'saved_models/model6.h5')
