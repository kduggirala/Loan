...
model = Sequential()
model.add(layers.LSTM(32, dropout = dropout, recurrent_dropout = dropout, input_shape = ((lookforward//steps - 1), 7)))
...
s3.Bucket('loan-performance-data').upload_file('model4.h5', 'saved_models/model4.h5')
