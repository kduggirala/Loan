...
testing_gen = generator(batch_size = batch_size, steps = steps, lookforward = lookforward, starting_from = 0.85)
...
s3.Bucket('loan-performance-data').upload_file('model7.h5', 'saved_models/model7.h5')
