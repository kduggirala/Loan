...
model.fit(train_gen, steps_per_epoch = epoch_steps, epochs = 20, validation_data = validation_gen, validation_steps = val_steps)

model.evaluate(testing_gen, steps = testing_steps)
model.save('model2.h5')
s3.Bucket('loan-performance-data').upload_file('model2.h5', 'saved_models/model2.h5')
